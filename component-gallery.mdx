...
<ZoomableMedia src="/logo/docs-mark.svg" alt="Documentation logo mark" caption="Click the media to inspect it in a larger overlay." />

## Inline TOC and do/don't

Use inline TOCs when a long guide needs a local jump list inside the main article.

<InlineTOC title="Jump to examples" items="Type table:#type-and-property-tables, API endpoint:#api-style-fields, Prompt:#color-prompt-tooltip-tree-view-and-visibility" />
...
<TypeTable title="Page frontmatter">
  <TypeTable.Property name="title" type="string" required>
    Displayed as the page heading and browser title.
  </TypeTable.Property>
  <TypeTable.Property name="description" type="string" required>
    Used in search, metadata, and `llms.txt` summaries.
  </TypeTable.Property>
  <TypeTable.Property name="tag" type="string" optional>
...
<ApiEndpoint method="GET" endpoint="/v1/demo-pages" baseUrl="https://api.example.com" auth="Bearer token" title="List demo pages" playground="/api-reference" />
