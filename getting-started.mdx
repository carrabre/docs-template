...
This installs Next.js, React, the MDX renderer, search helpers, icons, syntax highlighting, Scalar's API reference renderer, and the optional AI assistant dependency.
...
You can also run documentation and TypeScript checks without building:
...
- `templates/`: Starter MDX page templates.
- `scripts/validate-docs.ts`: Authoring and link validation.
