...
<ApiEndpoint method="POST" endpoint="/v1/demo-pages" baseUrl="https://api.example.com" auth="Bearer token" title="Create a demo page" playground="/api-reference" />
...
Open the [API playground](/api-reference) to inspect the OpenAPI file with Scalar.
